...
[![Build Status](https://build.se.informatik.uni-kiel.de/jenkins/buildStatus/icon?job=qa-eclipse-plugin-pipeline%2Fmaster)](http://build.se.informatik.uni-kiel.de/jenkins/job/qa-eclipse-plugin-pipeline/)
