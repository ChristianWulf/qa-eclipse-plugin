		...
		Display.getDefault().asyncExec(new Runnable() {
			...
			public void run() {
				...
				try {
					...
					final IViewPart viewPart = activePage.showView(CheckstyleViolationsView.ID, null,
							IWorkbenchPage.VIEW_VISIBLE);
					final CheckstyleViolationsView violationView = (CheckstyleViolationsView) viewPart;

					final Object input = new CheckstyleViolationMarker(marker);
