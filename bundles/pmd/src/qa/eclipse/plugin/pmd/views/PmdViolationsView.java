...
implements ISelectionChangedListener, IResourceChangeListener, IDoubleClickListener {
	...
	private static final String FILTERED_PART_NAME_FORMAT_STRING = PmdViolationsView.TOOL_NAME + " Violations (%d of %d)";
	...
	public void createPartControl(final Composite parent) {
		...
		clearButton.addListener(SWT.Selection, new Listener() {
			...
			public void handleEvent(final Event event) {
				...
				final List<PmdViolationMarker> violationMarkers = (List<PmdViolationMarker>) PmdViolationsView.this.tableViewer.getInput();
		...
		tableCombo.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(final SelectionEvent e) {
				...
				PmdViolationsView.this.viewPreferences.putInt(PmdViolationsView.PREF_FILTER_PRIORITY, lowestPriority); // save filter setting
		...
		this.tableViewer = new TableViewer(composite, SWT.V_SCROLL | SWT.BORDER | SWT.FULL_SELECTION | SWT.HIDE_SELECTION);
	...
	private void createColumns() {
		...
		column.setWidth(50);
		column.addSelectionListener(new CompareOnSelectListener(this.viewPreferences, this.tableViewer, PmdViolationMarkerComparator.SORT_PROP_PRIORITY));
		...
		column.setData(this.tableViewer.getTable().getColumnCount() - 1); // necessary for save/load
		column.setWidth(200);
		column.addSelectionListener(new CompareOnSelectListener(this.viewPreferences, this.tableViewer, PmdViolationMarkerComparator.SORT_PROP_RULENAME));
		column.addListener(SWT.Move, columnMovedListener);
		...
		column.setData(this.tableViewer.getTable().getColumnCount() - 1); // necessary for save/load
		column.setWidth(400);
		column.addSelectionListener(new CompareOnSelectListener(this.viewPreferences, this.tableViewer, PmdViolationMarkerComparator.SORT_PROP_VIOLATION_MSG));
		column.addListener(SWT.Move, columnMovedListener);
		...
		column.setData(this.tableViewer.getTable().getColumnCount() - 1); // necessary for save/load
		column.setWidth(100);
		column.addSelectionListener(new CompareOnSelectListener(this.viewPreferences, this.tableViewer, PmdViolationMarkerComparator.SORT_PROP_PROJECTNAME));
		column.addListener(SWT.Move, columnMovedListener);
		...
		column.setData(this.tableViewer.getTable().getColumnCount() - 1); // necessary for save/load
		column.setWidth(50);
		column.addSelectionListener(new CompareOnSelectListener(this.viewPreferences, this.tableViewer, PmdViolationMarkerComparator.SORT_PROP_LINENUMBER));
		column.addListener(SWT.Move, columnMovedListener);
		...
		column.setData(this.tableViewer.getTable().getColumnCount() - 1); // necessary for save/load
		column.setWidth(100);
		column.addSelectionListener(new CompareOnSelectListener(this.viewPreferences, this.tableViewer, PmdViolationMarkerComparator.SORT_PROP_RULESET));
		column.addListener(SWT.Move, columnMovedListener);
	...
	private void updateTabTitle(final int numFilteredViolations, final int numViolations) {
		final String newPartName = String.format(PmdViolationsView.FILTERED_PART_NAME_FORMAT_STRING, numFilteredViolations,
				numViolations);
	...
	private void updateNumViolationsLabel(final int numFilteredViolations, final int numViolations) {
		final String text = String.format(PmdViolationsView.NUMBER_OF_PMD_VIOLATIONS_FORMAT_STRING, numFilteredViolations, numViolations);
